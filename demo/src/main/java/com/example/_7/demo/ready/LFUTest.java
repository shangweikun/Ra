...
//        System.out.println(cache.get(5));
        ...
        com.example._7.demo.LFUCache cache1 = new com.example._7.demo.LFUCache(10);
        ...
        for (String one : tmp) {
            ...
            if (list.length == 1) {
                ...
                int result1 = cache1.get(Integer.parseInt(list[0]));
            ...
            if (list.length == 2) {
                ...
                if (list[0].equals("7") && list[1].equals("22")) {
                    System.out.println("in");
                }

                cache.put(Integer.parseInt(list[0]), Integer.parseInt(list[1]));
                cache1.put(Integer.parseInt(list[0]), Integer.parseInt(list[1]));
